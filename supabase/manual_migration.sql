...
-- =============================================
-- Since the local machine cannot connect to Supabase (network/DNS issue),
-- run these SQL statements in the Supabase SQL Editor:
-- https://ysenimczeasmaeojzlkt.supabase.co/project/-/sql

-- =============================================
-- MIGRATION 1: Journal Entries Table
-- Run first: 20260412090000_create_journal.sql
-- =============================================
...
-- Run second: 20260413000000_create_score_history.sql
-- =============================================
